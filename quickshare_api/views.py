...
class ListViewGet(APIView):
    ...
    def get_object(self, list_id):
        ...
        '''
        try:
            return List.objects.get(list_id=list_id)
    ...
    def get(self, request, list_id, *args, **kwargs):
        ...
        '''
        todo_instance = self.get_object(list_id)
        ...
        serializer = QuickshareSerializer(todo_instance)
        return Response(serializer.data, status=status.HTTP_200_OK)
...
class ListViewPost(APIView):
    def post(self, request, *args, **kwargs):
            ...
            data = {
                ...
                'create_data': datetime.date.today(),
            }
            serializer = QuickshareSerializer(data=data)
            if serializer.is_valid():
                serializer.save()
